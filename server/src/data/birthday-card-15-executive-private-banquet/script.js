...
var screenOrder = ["cover", "identity", "message", "honor", "reflection", "signoff", "final"];
const palettes = {
...
const totalPages = 7;
const totalDuration = 26000; // 26秒
const autoPlayInterval = totalDuration / totalPages; // 每页约3.71秒
